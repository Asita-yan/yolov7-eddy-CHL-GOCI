...
#     in_file = open(os.path.join(VOCdevkit_path, 'E:\\photo\\04\\Annotations/%s.xml' % (image_id)), encoding='utf-8')
...
# files=os.listdir('E:\\photo\\04\\Annotations')
# for file in files:
...
def convert_annotation(hour, image_id, list_file):
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for year, image_set in VOCdevkit_sets:
            ...
            for image_id in image_ids:
                list_file.write('%s/%s00CHL.nc' % (os.path.abspath(data_path), image_id))
